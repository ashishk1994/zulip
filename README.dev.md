...
=============================================
If you are building the development environment behind the network proxy then make sure your proxy variables are set. 
...
- Also add a blank .npmignore file into the main zulip directory
  ```
     touch .npmignore
  ```
